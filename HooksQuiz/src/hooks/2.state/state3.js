...
function State3() {
  /*
    ...
    1. 구매후기 및 상제를 제외한 데이터의 모든 정보는 화면에 노출되어야 합니다.v
        단, 가격표는 3자리마다 ,를 작성해야합니다.v

    2. 해당 상품을 클릭하면 상세 페이지로 이동합니다. v
    
    3.
      상세페이지 주소에는 클릭한 상품의 상품번호가 노출되어야 합니다 v
      ...
      -데이터들을 따로관리 productNumber기준으로 변경하는애들만 랜더링시켜주기
