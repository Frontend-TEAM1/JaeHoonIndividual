...
function Q3() {
  ...
  */
    ...
    /*
    handleStart가 click -> isStart에 true -> 컴포넌트 보임


    handleStop click -> isStart에 false -> 컴포넌트 안보임
  ...
  return (
    <>
      ...
      <div>
        ...
        />}
        <p>
          <button onClick={handleStart}>줄넘기 시작</button>
        </p>
        <p>
          <button onClick={handleStop}>줄넘기 중지</button>
        </p>
      </div>
    </>
  );
